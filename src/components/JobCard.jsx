...
const JobCard = ({job}) => {
  ...
  return (
    <div className='border p-6 shadow rounded'>
        ...
        <div className=' flex-col items-center  gap-3 mt-2 text-xs'>
           ...
           <div className='mt-4 flex gap-4 text-sm'>
             ...
             <button onClick={()=>{navigate(`/apply-jobs/${job._id}`);scrollTo(0,0)}} className='text-gray-500 border border-gray-500 px-4 py-2 rounded'>Learn more</button>
           </div>
        </div>
    </div>
  )
