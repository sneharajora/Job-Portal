            ...
            {JobCategories.map((category, index) => (
              <li className="flex gap-3 items-center" key={index}>
                <input
                  className="scale-125"
                  type="checkbox"
                  onChange={() => handleCategoryChange(category)} // Pass category to the handler
            ...
            {JobLocations.map((location, index) => (
              <li className="flex gap-3 items-center" key={index}>
                <input
                  className="scale-125"
                  type="checkbox"
                  onChange={() => handleLocationChange(location)} // Pass location to the handler
                  checked={selectedLocations.includes(location)} // Check if location is selected
                />
                {location}
              </li>
            ))}
